...
import { useFirstCarouselImages } from "@/hooks";
      ...
      <main className="flex-1 flex flex-col items-center px-4">
        ...
        >
          <p>
            ...
            Just show up to a session for your age group—your, the first taster
            session is free to ensure you love it before committing
            <br />
            <br />
